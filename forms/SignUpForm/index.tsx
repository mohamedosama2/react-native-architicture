  ...
  return (
    <View style={styles.loginContainer}>
      ...
      <Formik
        ...
        {({ handleSubmit, isValid, setFieldValue, setFieldTouched, values, errors, touched }) => (
          <>
            ...
            <Field component={CustomInput} name="post" placeholder="Write post..." multiline numberOfLines={3} />
            <TouchableOpacity
              onPress={() => {
            ...
            {values.photo && <Text>{`...${values.photo.fileName.substr(values.photo.fileName.length - 10)}`}</Text>}

            {errors.photo && touched.photo && <Text style={{ width: 20, height: 20 }}>{values.photo.fileName}</Text>}
